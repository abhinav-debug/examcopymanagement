...
--
-- Host: localhost    Database: cs_records
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'cs_records'
--
/*!50003 DROP PROCEDURE IF EXISTS `migrateCS` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `migrateCS`()
BEGIN
...
-- Dump completed on 2020-03-24 11:14:55
